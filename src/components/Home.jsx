      ...
      >
        ...
        <div>
          <h1 className={`${styles.homeHeadText}`}>
            Hi, I'm&nbsp;
            <span className="text-[#915eff] whitespace-nowrap">Chan</span>
          </h1>
          ...
          <p className={`${styles.homeSubText} mt-2 text-white-100`}>
            I am a <span className="text-[#915eff]">seeker of simplicity</span> first,
            <br/>a <span className="text-[#915eff]">developer </span>second,
            <br/>
            and a <span className="text-[#915eff]">lover of nature</span> third.
          </p>
        </div>
      </div>
      <ComputersCanvas/>
